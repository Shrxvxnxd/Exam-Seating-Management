            ...
            <div className="container mx-auto px-6">
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm font-semibold text-slate-400">
                            ...
                            <li><FooterLink href="/faculty/login" text="Faculty Login" /></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm font-semibold text-slate-400">
                            ...
                            <li><FooterLink href="/terms" text="Malpractice Policy" /></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-5 text-sm font-medium text-slate-400">
                            <li className="flex items-start gap-3">
                                ...
                                <span className="leading-relaxed">VFSTRH Deshmukhi Village,<br />Pochampally (Mandal),<br />Yadadri-Bhuvanagiri District,<br />Telangana State</span>
                            </li>
                            ...
                            <li className="flex items-center gap-3">
                                ...
                                <span className="text-white">support@vignan.ac.in</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="pt-8 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-6">
                    <p className="text-slate-500 text-xs font-bold uppercase tracking-widest">
                        &copy; {currentYear} Student Portal Smart Management. All rights reserved.
                    </p>

                    <p className="flex items-center gap-1.5 text-slate-600 text-[10px] font-bold uppercase tracking-widest hover:text-emerald-500 transition-colors cursor-default">
                        Developed with <Heart size={10} className="text-red-500 fill-current animate-pulse" /> by Shravan Kumar Goud Babburu
                    </p>
