...
import { RefreshCcw, ShieldAlert, Cpu, Activity, Server, Zap } from 'lucide-react';
...
export default function ServerBusy() {
    ...
    const handleRetry = () => {
        setIsRetrying(true);
        setLogs(prev => [...prev, ">>> INITIATING RECONNECTION SEQ..."]);
        setTimeout(() => {
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] text-white flex items-center justify-center p-4 relative overflow-hidden font-sans">
            ...
            {/* --- Dynamic Background --- */}
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,_rgba(120,0,0,0.1),transparent_70%)]"></div>
            <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-red-500/20 to-transparent"></div>
            <div className="absolute bottom-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-red-500/20 to-transparent"></div>
            ...
            >
                ...
                <div className="bg-[#111] border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden backdrop-blur-xl">
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-start">
                        ...
                        <div className="flex-shrink-0 flex flex-col items-center">
                            <div className="w-20 h-20 bg-red-900/20 rounded-2xl border border-red-500/30 flex items-center justify-center mb-6 relative">
                        ...
                        <div className="flex-grow w-full">
                            <h1 className="text-3xl font-bold text-white mb-2 tracking-tight flex items-center gap-3">
                                System Capacity Full
                            </h1>
                            <p className="text-gray-400 leading-relaxed mb-8">
                                We are currently handling maximum traffic (500+ active sessions).
                                Your request is queued effectively.
                            </p>
                ...
                <div className="mt-8 flex justify-between items-center text-xs text-gray-600 px-4">
                    <div>Session ID: <span className="font-mono text-gray-500">TRX-{Math.random().toString(36).substr(2, 9).toUpperCase()}</span></div>
