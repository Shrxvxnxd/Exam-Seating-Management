...
import { User, BookOpen, Calendar, Layers, Hash, CheckCircle, AlertCircle, Sparkles, LogOut, ArrowRight, Loader2, Info, Clock } from 'lucide-react';
...
export default function CompleteProfile() {
    ...
    if (authLoading) return <PremiumLoader text="Verifying Session" subText="Identifying user context..." />;
        ...
        <div className="min-h-screen bg-white flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 font-sans relative overflow-hidden">
            ...
            >
                ...
                <div className="text-center">
                    ...
                    <div className="flex flex-col items-center gap-2 mb-4">
                        <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight">
                            {isMounted ? greeting : 'Hello'}, <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-violet-600">{user?.full_name?.split(' ')[0] || 'Student'}</span>
                        </h2>
                        {isMounted && currentTime && (
                            <div className="flex items-center gap-1.5 px-3 py-1.5 bg-white shadow-md border border-slate-100 rounded-2xl text-slate-500 font-bold text-sm">
                ...
                >
                    ...
                    {/* Loading Overlay */}
                    {loading && <PremiumLoader text="Finalizing Profile" subText="Synchronizing academic records..." />}
                </motion.div>
            </motion.div>
        </div>
    );
